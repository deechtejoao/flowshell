...
func PortAnchorID(n *Node, output bool, index int) clay.ElementID {
	if output {
		return clay.IDI("NodeOutPortAnchor", n.ID*1000+index)
	}
	return clay.IDI("NodeInPortAnchor", n.ID*1000+index)
}
